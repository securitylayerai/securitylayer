...
SecurityLayer auto-detects which AI tool triggered a command and applies the appropriate capability profile. The callers command lets you view these profiles.
...
When a command is intercepted (via shell shim or hook), SecurityLayer checks:
